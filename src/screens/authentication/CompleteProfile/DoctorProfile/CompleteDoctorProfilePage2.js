...
const CompleteDoctorProfilePage2 = ({ formValues, pickImage, removeImage }) => {
  return (
    <View style={[styles.subContainer, { flex: 1 }]} >
      ...
      <View style={{ marginTop: 20, flex: 1, justifyContent: 'center' }}>
        {!formValues.profile_picture ?
          <Pressable onPress={pickImage} style={{ borderWidth: 1, borderStyle: 'dashed', height: 350, borderRadius: 10, alignItems: 'center', justifyContent: 'center' }}>
...
export default CompleteDoctorProfilePage2;